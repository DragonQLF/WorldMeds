...
export const MapLegend: React.FC<MapLegendProps> = ({ 
  ...
  return (
    <div 
      className={cn(
        "fixed p-2 rounded-md shadow-lg",
        leftPositionClass,
        bottomPositionClass,
        isMobile ? "w-auto max-w-[80vw]" : "w-auto max-w-[180px] sm:max-w-xs md:w-64",
      ...
      <div className="text-sm font-medium mb-2 flex justify-between items-center">
        ...
        {isMobile && (
          <button 
            ...
            className="ml-2 p-1 rounded-full hover:bg-gray-700/50 focus:outline-none"
          >
            {isExpanded ? (
